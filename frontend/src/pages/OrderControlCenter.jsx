...
export default function OrderControlCenter() {
    ...
    const visibleColumns = [
        { id: 'orderId', label: t('ordersControl.grid.orderId') },
        { id: 'customer', label: t('ordersControl.grid.customer') },
        { id: 'phone', label: t('ordersControl.grid.phone') },
        { id: 'location', label: t('ordersControl.grid.location') },
        { id: 'products', label: t('ordersControl.grid.products') },
        { id: 'total', label: t('ordersControl.grid.total') },
        { id: 'courier', label: t('ordersControl.grid.courier') },
        { id: 'agent', label: t('ordersControl.grid.agent') },
        { id: 'date', label: t('ordersControl.grid.age') },
        { id: 'status', label: t('ordersControl.grid.status') },
        { id: 'actions', label: '' },
    ];
                ...
                <div className="flex items-center gap-6">
                    {kpis && (
                        <div className="hidden lg:flex items-center gap-4 mr-4 divide-x divide-gray-100">
                            ...
                            <div className="flex flex-col pl-4">
                                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">{t('ordersControl.kpis.dispatched')}</span>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="relative">
                            ...
                            >
                                <LayoutTemplate className="w-4 h-4" /> {t('ordersControl.columnsBtn')}
                            </button>
                            {showColumnManager && (
                                <div className="absolute top-10 right-0 w-48 bg-white border border-gray-100 shadow-xl rounded-xl z-50 p-2 py-3 flex flex-col gap-1">
                                    <div className="text-[10px] uppercase font-black tracking-widest text-gray-400 px-3 pb-2 border-b border-gray-100 mb-1">{t('ordersControl.visibleColumnsTitle')}</div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            >
                                ...
                                {bulkActionType === 'status' && (activeStage === 'post-dispatch'
                                    ? ['Delivered', 'Returned', 'Out for Delivery', 'Paid'].map(s => <option key={s} value={s}>{t(`sales.status${s.replace(/\s+/g, '')}`) || s}</option>)
