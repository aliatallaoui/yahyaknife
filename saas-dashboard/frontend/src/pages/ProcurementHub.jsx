        ...
        <div className="p-8 pb-32">
            <div className="flex justify-between items-start mb-8 border-b border-gray-200 pb-5">
                <div>
                    ...
                    <p className="text-gray-500 mt-2 font-medium">Manage supply chain, purchase orders, and vendor performance.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-sm font-bold text-gray-500">Active POs</p>
                ...
                <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-sm font-bold text-gray-500">Completed This Month</p>
                ...
                <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-sm font-bold text-gray-500">Active Suppliers</p>
                ...
                <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-sm font-bold text-gray-500">Delayed Shipments</p>
                        <p className="text-2xl font-black text-gray-900">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div className="flex border-b border-gray-200 bg-gray-50/50">
                    ...
                    >
                        <FileText className="w-4 h-4" /> Active Purchase Orders
                    </button>
                    <button
                ...
                {loading ? (
                    <div className="p-12 text-center text-gray-500">Loading supply chain data...</div>
                ) : (
                    <div className="p-0">
                        {activeTab === 'orders' && (
                            <table className="w-full text-left text-sm">
                                <thead className="bg-gray-50 text-gray-500 font-medium border-b border-gray-200">
                                    <tr>
                                        ...
                                        <th className="p-4">Expected Target</th>
                                        <th className="p-4">Total Amount (DZD)</th>
                                    ...
                                    {orders.length === 0 ? (
                                        ...
                                        <tr key={order._id} className="border-b border-gray-100 hover:bg-gray-50/50 transition-colors">
                                            ...
                                            <td className="p-4">
                                                ...
                                                <div className="text-xs text-gray-500">Trust Score: {order.supplier?.performanceMetrics?.reliabilityScore}%</div>
                                            </td>
                                            <td className="p-4">
                            ...
                            <table className="w-full text-left text-sm">
                                <thead className="bg-gray-50 text-gray-500 font-medium border-b border-gray-200">
                                    <tr>
                                        ...
                                        <th className="p-4">Reliability Score</th>
                                        <th className="p-4">Status</th>
                                        <th className="p-4">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {suppliers.length === 0 ? (
                                        <tr><td colSpan="6" className="p-8 text-center text-gray-500">No suppliers registered.</td></tr>
                                    ) : suppliers.map(sup => (
                                        <tr key={sup._id} className="border-b border-gray-100 hover:bg-gray-50/50 transition-colors">
                                            ...
                                            <td className="p-4 text-gray-600">{sup.performanceMetrics?.averageLeadTimeDays} days</td>
                                            <td className="p-4">
                                            ...
                                            <td className="p-4">
                                                <button className="text-gray-600 hover:text-gray-900 font-bold text-sm">Edit profile</button>
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>
