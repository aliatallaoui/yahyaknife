                ...
                actions={
                    <div className="flex gap-3">
                        <button 
                            ...
                            className="flex items-center gap-2 px-5 py-2.5 bg-white text-gray-700 hover:bg-gray-50 font-medium rounded-xl border border-gray-200 transition-all shadow-sm active:scale-95 leading-none"
                        >
                                ...
                                {couriers.length === 0 ? (
                                    ...
                                    filteredCouriers.map((c) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4">
                                                <span className="font-bold text-gray-900">{c.totalDeliveries?.toLocaleString() || 0}</span>
                                            </td>
                                            <td className="px-6 py-4">
                                                <span className={clsx("font-bold", (c.successRate || 0) > 80 ? "text-green-600" : "text-yellow-600")}>
