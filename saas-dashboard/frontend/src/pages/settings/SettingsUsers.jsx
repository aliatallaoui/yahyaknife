...
export default function SettingsUsers() {
    ...
    if (loading) return <div className="p-8 text-gray-500 font-medium">Loading User Access matrix...</div>;
        ...
        <div className="max-w-6xl mx-auto">
            <div className="mb-8 flex items-end justify-between">
                <div>
                    ...
                    <p className="text-gray-500 mt-2">Manage employee system access, roles, and authorization limits.</p>
                </div>
                <button
                ...
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="bg-gray-50/80 text-gray-500 text-xs uppercase tracking-wider">
                            <th className="p-4 font-semibold pl-6">Core Identity</th>
                            <th className="p-4 font-semibold">Security Role</th>
                            <th className="p-4 font-semibold">Status</th>
                            <th className="p-4 font-semibold">Joined Date</th>
                            <th className="p-4 font-semibold text-right pr-6">Manage</th>
                        </tr>
                    </thead>
                    ...
                    <div className="bg-white rounded-3xl shadow-xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                        <div className="px-6 py-5 border-b border-gray-100 bg-gray-50/50 flex justify-between items-center">
                            <h3 className="font-bold text-gray-900 text-lg flex items-center gap-2">
                                ...
                                {editUser ? 'Modify User Security' : 'Invite New System User'}
                            </h3>
                        ...
                        <div className="p-6 space-y-5">
                            {!editUser && (
                                <>
                                    ...
                                    <div>
                                        <label className="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wide">Initial Password</label>
                                        <input
                                            type="password"
                            ...
                            <div>
                                <label className="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wide">Assigned Role</label>
                                <select
                            ...
                            {editUser && (
                                <div>
                                    <label className="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wide">Login Status</label>
                                    <div className="flex gap-3 mt-2">
                                        ...
                                        >
                                            <XCircle className="w-4 h-4" /> Restricted (Locked)
                                        </button>
                                    </div>
                                </div>
                            )}
                        ...
                        <div className="px-6 py-4 bg-gray-50 flex justify-end gap-3 border-t border-gray-100">
                            ...
                            >
                                {editUser ? 'Save Security Policy' : 'Create Credentials'}
                            </button>
                        </div>
                    </div>
                </div>
