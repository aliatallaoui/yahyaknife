...
import { FileText, Edit3, PhoneCall, MessageCircle, CheckCircle2, Truck, AlertTriangle } from 'lucide-react';
                                        ...
                                        >
                                            ...
                                            {visibleColumns.map((col) => {
                                                switch (col.id) {
                                                    ...
                                                    case 'actions':
                                                        return (
                                                            <td key={col.id} className="px-4 py-2 text-end" onClick={e => e.stopPropagation()}>
                                                    ...
                                                    case 'total':
                                                        return (
                                                            <td key={col.id} className="px-4 py-2 text-end">
                                                            ...
                                                            <div className="flex flex-col bg-white border border-gray-100 rounded-lg p-3 shadow-sm">
                                                                ...
                                                                <div className="flex flex-col gap-1.5 text-xs">
                                                                    ...
                                                                    <div className="flex items-start justify-between mt-1 gap-2">
                                                                        ...
                                                                        <span className="font-semibold text-gray-800 leading-tight text-end line-clamp-2" title={order.shipping?.address}>{order.shipping?.address || order.commune}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
